    ...
    <div class="head">
      <div class="list">
        <div class="item firstChild">
          <div class="number">{{allCount.amount | formatMoney}}</div>
          <div>总收入</div>
        </div>
        <div class="item">
          <div class="number">¥{{monthCount.amount | formatMoney}}</div>
          <div>当月收入</div>
        </div>
      </div>
    </div>
      ...
      <scroller lock-x @on-scroll-bottom="onScrollBottom" ref="scrollerBottom2" :scroll-bottom-offst="300"
        ...
        <div class="list">
          <div class="item" v-for="(x,index) in orderList">
            <img :src="icon_skcg" class="leftImg" alt="">
...
<script>
  import icon_skcg from "@/assets/merchant/icon_skcg.png"
  import icon_sksb from "@/assets/merchant/icon_sksb.png"
