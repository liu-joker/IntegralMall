<template>
  ...
  <div class="applicationForm">
    <div class="head">
      <div class="item" v-for="(x,index) in titleList" :class="formActive == index?'active':''" @click="changeFormActive(index)">{{x}}</div>
    </div>
    <div class="formComponent">
      <div class="form" v-show="formActive == 0">
        ...
        <group class="inputItem groupCard">
      ...
      <div class="form" v-show="formActive == 1">
        ...
        <group class="inputItem">
          <cell is-link @click.native="show10 = true">
            <div class="cellTitle" slot="title">
              <span class="requestSpan"> * </span>选址定位:
            </div>
            <div class="cellContent">
              <span class="selectValue">请选择实际经营地址</span>
            </div>
          </cell>
        </group>
        <group class="inputItem">
        ...
        <div class="popupDiv">
          <popup v-model="show2" height="35%" class="popup">
            <div class="popupHead">
              <p>请选择商家性质</p>
              <span @click="show2 = false"><svg-icon slot="label" class="form_icon" icon-class="close"></svg-icon></span>
        ...
        <div class="popupDiv">
          <popup v-model="show3" height="35%" class="popup">
            <div class="popupHead">
              <p>请选择商家性质</p>
              <span @click="show3 = false"><svg-icon slot="label" class="form_icon" icon-class="close"></svg-icon></span>
      ...
      <div class="form" v-show="formActive == 2"></div>
    </div>
    <div class="foot_but">
