<template>
  ...
  <div class="Index_2 commodityTypeList">
    <div class="header">
      <div class="grabble" ref="grabble">
        ...
        <div class="right" @click="toMy" v-if="$Cookie.getToken() != ''">
        ...
        <div class="commodity_content">
          <swiper :options="swiperOption2" ref="mySwiper2"
            ...
            <swiper-slide v-for="(item, index) in selectList" :key="index"
                          :class="index == selectValue ? 'slideActive':''">
    ...
    computed: {
      headBgc: function () {
        ...
        if (!!u.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/)) {
          return 'background-color: rgba(243, 57, 69, 1)'
        }
        return 'background-color: rgba(243, 57, 69, ' + top + ')'
      },
...
//                v.shopList = v.shopList.concat(shopList)
      ...
      selectData(i, index) {
        ...
        this.swiperOption2.autoHeight = true
        this.swiper.update()
